...
namespace Utilities
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa22_3342_tuh03252;User id=tuh03252;Password=ooK3shai3p";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=fa22_3342_tuh03252;User id=tuh03252;Password=ooK3shai3p";
