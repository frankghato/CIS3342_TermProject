...
namespace CIS3342_TermProject
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        {
            WebRequest request = WebRequest.Create("https://cis-iis2.temple.edu/Fall2022/CIS3342_tuh03252/webapi/api/post/" + username);
            WebResponse response = request.GetResponse();
            Stream dataStream = response.GetResponseStream();
            StreamReader reader = new StreamReader(dataStream);
            String data = reader.ReadToEnd();
        ...
        protected void rptPosts_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            try
            {
                WebRequest request = WebRequest.Create("https://cis-iis2.temple.edu/Fall2022/CIS3342_tuh03252/webapi/api/post/DeletePost/" + id);
